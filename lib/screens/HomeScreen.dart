                        ...
                        children: [
                          ...
                          myUid==null||myUid==""?SizedBox.shrink(): Positioned(
                            ...
                            child: Container(
                              ...
                              child:isLoding==true?Center(child: CircularProgressIndicator()): Center(child:getNotificationData.results.length==null||getNotificationData.results.length==""?SizedBox.shrink(): Text('${getNotificationData.results.length}',style: TextStyle(color: Colors.black,fontSize: 10),)),
                            ),
                          ),
