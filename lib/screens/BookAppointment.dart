...
class _BookAppointmentState extends State<BookAppointment> {
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                             _selectDate(context,current_index1);
                        ...
                        Center(child: CircularProgressIndicator()):Container(
                          ...
                          child:  getTimeSlotModel.data!=null||getTimeSlotModel.data!=""? ListView.builder(
                              ...
                              itemBuilder: (context, index){
                                ...
                                current_index1 = getTimeSlotModel.availableDays[index].day;
                                  ...
                                  child: InkWell(
                                    onTap: (){
                                      ...
                                      setState(() {
                                        ...
                                        myDay = getTimeSlotModel.availableDays[index].day;
                                    ...
                                    child:  Container(
                                      decoration: BoxDecoration(
                                        border: Border.all(color: Colors.red),
                                          ...
                                          color: myDay.toString().toUpperCase() == getTimeSlotModel.availableDays[index].day? LIME : Colors.white
                                      ),
                                      height: 50,
                                      width: 120,
                                      child: Center(child: Text("${getTimeSlotModel.availableDays[index].day} - ${getTimeSlotModel.availableDays[index].from}-${getTimeSlotModel.availableDays[index].to}",
                                        style: TextStyle(
                                            ...
                                            color:myDay.toString().toUpperCase() == getTimeSlotModel.availableDays[index].day?Colors.white : LIME
                                        ),)),
                                    ),
                                  ),
                                ):SizedBox.shrink();
  ...
  Future<Null> _selectDate(BuildContext context,current_Index1) async {
    ...
    if (picked != null)
      ...
      setState(() {
        selectedDate = picked;
        myDay = DateFormat('EEEE').format(selectedDate);
        print('Dayyyyyyyyyyy${DateFormat('EEE').format(selectedDate)}');
